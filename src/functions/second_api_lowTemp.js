const getSecondAPI_lowtemp = async (API_KEY, currentDate, currentLocation, time, row) => { // 3시간 마다
  ...
  try {
    ...
    console.error('getSecondAPI_lowtemp.js', err);
  }
  ...
  //       if (this.status == 200) {
  //         // 요청이 성공했을 때 응답 처리
  //         console.log('Status: 2_2', this.status);
  //         // console.log('Headers:', this.getAllResponseHeaders());
  //         // console.log('Body:', this.responseText);
  //         sessionStorage.setItem('res2_lowTemp', this.responseText);
...
export default getSecondAPI_lowtemp