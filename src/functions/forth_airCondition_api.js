const GetForth_airCondition_API = (key) => { // 1일 2회(06, 18)
  ...
  return new Promise((resolev, reject) => {
    ...
    queryParams += '&' + encodeURIComponent('searchDate') + '=' + encodeURIComponent(`${currentDate}`); /**/
...
export default GetForth_airCondition_API
