...
const getCurrentTime = () => {
  ...
  let currentTime =
    getCurrentTime.length > 3
      ? getCurrentTime
      : "0".repeat(4 - getCurrentTime.length) + getCurrentTime;
    ...
    <>
      {loading ? (
        ...
        <div className="Home_wrap">
          ...
          >
            <Site2
              temperature={timeSessionTMPData}
              sky={timeSessionSKYData}
              time={currentTime}
            />
            <Site3
              data={weeklyData}
              weatherState={dailyState}
